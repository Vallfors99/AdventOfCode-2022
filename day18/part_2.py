...
def get_cube_neighbors(cube,other_cubes):
    ...
    neighbors = []
    neighbor_1 = (cube[0],cube[1],cube[2]+1)
    neighbor_2 = (cube[0],cube[1],cube[2]-1)
    neighbor_3 = (cube[0],cube[1]+1,cube[2])
    neighbor_4 = (cube[0],cube[1]-1,cube[2])
    neighbor_5 = (cube[0]+1,cube[1],cube[2])
    neighbor_6 = (cube[0]-1,cube[1],cube[2])
